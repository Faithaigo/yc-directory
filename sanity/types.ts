...
// Query: *[_type == "startup"  && defined(slug.current) && !defined($search) || title match $search || category match $search || author -> name match $search] | order(_createdAt desc){  _id, title, slug, author ->{    _id, name, bio, image  },views, description, slug, _createdAt, image, category}
...
// Query: *[_type == "startup" && _id == $id][0]{  _id, title, slug, author ->{    _id, name,username, bio, image  },views, description, pitch, slug, _createdAt, image, category}
...
// Query: *[_type == "author" && id == $id][0]{  _id, id, name, username, bio, image, email  }
...
// Query: *[_type == "author" && _id == $id][0]{  _id, id, name, username, bio, image, email  }
...
// Query: *[_type == "startup" && author._ref == $id] | order(_createdAt desc){  _id, title, slug, author ->{    _id, name, bio, image  },views, description, slug, _createdAt, image, category}
...
export type PLAYLIST_BY_SLUG_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  select: Array<{
